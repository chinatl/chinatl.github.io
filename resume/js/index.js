$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫唐兰，是西安一家互联网创业公司的软件工程师</div>");
	...
	w.load("<ul>");
	w.load("<li class='writecode'>mail:codekidlan@gmail.com</li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/chintl' target='_blank'>'https://github.com/chintl'</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>精通javascript,使用js面向对象编程");
	w.load("<li class='writecode'>熟练Nodejs技术,熟练运用express框架</li>");
	w.load("<li class='writecode'>熟练各种Web前端开发技术H5,CSS3,jQuery,React,Angular,Vue</li>");
	w.load("<li class='writecode'>熟练微信小程序开发，微信公众号开发</li>");
	w.load("<li class='writecode'>熟练使用webpack打包项目，压缩混淆代码</li>");
	w.load("<li class='writecode'>熟练各种状态管理工具,vuex,mobx,redux</li>");
	w.load("<li class='writecode'>熟练使用echarts,highcharts插件</li>");
	w.load("<li class='writecode'>熟练git等常用版本管理工具</li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>项目</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'><a href='https://github.com/chintl' target='_blank'>(内网，不可访问附上github地址)</a></li>");
	w.load("</ul>");
	c.load("<p><div class='comment writecode'>/**</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:1663629808</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:15719289905</div>");
